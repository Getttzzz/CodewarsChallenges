...
val LanguagesTestData = listOf("python", "kotlin", "javascript", "haskell", "csharp", "sql")

val ChallengeTestData = Challenge(
    id = "some_id",
    name = "Find the missing latter",
    completedLanguages = LanguagesTestData,
    completedAt = "2017-02-12T10:29:27.794Z",
)

val ChallengesTestData = listOf(
    ChallengeTestData,
    ChallengeTestData,
    ChallengeTestData,
    ChallengeTestData,
...
val ChallengeDetailsTestData = ChallengeDetails(
    id = "some_id",
    "Odd or Even?",
...
val ChallengesPaginatedTestData = PaginatedData(
    data = ChallengesTestData,
    totalItems = ChallengesTestData.size,
    totalPages = 1,
)
